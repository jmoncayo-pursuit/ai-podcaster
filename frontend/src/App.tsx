  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='AI-powered podcast creation platform.'
        />
        <meta
          name='keywords'
          content='AI, podcast, audio, creation'
        />
        <meta name='author' content='AI Podcaster Team' />
      </Helmet>
                ...
                {aiStatus === 'done' && aiConversation.length > 0 && (
                  <Box mt={3}>
                    <Alert severity='success' sx={{ mb: 2 }}>
                      AI conversation generated! Review and edit
                      below.
                    </Alert>
                    <Typography
                      variant='subtitle1'
